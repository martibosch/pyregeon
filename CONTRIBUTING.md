...
1. The pull request should work for Python 3.8, 3.9, 3.10 and 3.11. Check https://github.com/martibosch/pyregeon/actions and make sure that the tests pass for all supported Python versions.
